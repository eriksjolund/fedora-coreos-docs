...
IMAGE_PATH=$(coreos-installer download -s "${STREAM}" -p qemu -f qcow2.xz --decompress -C ~/.local/share/libvirt/images/)
----
...
[source, bash]
----
qemu-img create -f qcow2 -F qcow2 -b "$IMAGE_PATH" my-fcos-vm.qcow2
